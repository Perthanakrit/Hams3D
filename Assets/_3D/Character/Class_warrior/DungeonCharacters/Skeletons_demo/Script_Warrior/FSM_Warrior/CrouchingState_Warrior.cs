...
public class CrouchingState_Warrior : State_Warrior
{
    float playerSpeed;
    bool belowCeiling;
    bool crouchHeld;
    ...
    public CrouchingState_Warrior(Character_Warrior _character, StateMachine_Warrior _stateMachine):base(_character, _stateMachine)
	{
