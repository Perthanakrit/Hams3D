...
public class JumpingState_Warrior : State_Warrior
{
    bool grounded;
    ...
    public JumpingState_Warrior(Character_Warrior _character, StateMachine_Warrior _stateMachine) : base(_character, _stateMachine)
	{
