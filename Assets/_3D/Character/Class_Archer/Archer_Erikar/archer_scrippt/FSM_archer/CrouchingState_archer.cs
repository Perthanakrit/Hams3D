...
public class CrouchingState_archer : State_archer
{
    float playerSpeed;
    bool belowCeiling;
    bool crouchHeld;
    ...
    public CrouchingState_archer(Character_archer _character, StateMachine_archer _stateMachine):base(_character, _stateMachine)
	{
