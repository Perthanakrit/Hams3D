...
public class EventManager : MonoBehaviour 
{
    ...
    public delegate void EventDelegate<T> (T e) where T : Quest_test;
    private delegate void EventDelegate (Quest_test e);
    ...
    private EventDelegate AddDelegate<T>(EventDelegate<T> del) where T : Quest_test
    {
    ...
    public void AddListener<T> (EventDelegate<T> del) where T : Quest_test
    {
        AddDelegate<T>(del);
    }

    public void AddListenerOnce<T> (EventDelegate<T> del) where T : Quest_test
    {
    ...
    public void RemoveListener<T> (EventDelegate<T> del) where T : Quest_test
    {
    ...
    public bool HasListener<T> (EventDelegate<T> del) where T : Quest_test
    {
        return delegateLookup.ContainsKey(del);
    }

    public void TriggerEvent (Quest_test e) {
        EventDelegate del;
    ...
    public bool QueueEvent(Quest_test evt) {
    ...
    void Update() {
        ...
        while (m_eventQueue.Count > 0) {
            ...
            Quest_test evt = m_eventQueue.Dequeue() as Quest_test;
            TriggerEvent(evt);
